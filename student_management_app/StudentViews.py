...
def student_view_attendance(request):
    ...
    # Getting Course Enrolled of LoggIn Student
...
def student_view_attendance_post(request):
    if request.method != "POST":
        ...
        # Parsing the date datat into Python object
        ...
        # Now Acessing Attendance Data based on the Range of Date
        # Selected and Subject Selected
        attendance = Attendance.objects.filter(attendance_data__range=(start_date_parse,
                                                                       end_date_parse),
                                                subject_id=subject_obj)
        # Getting Attendance Report based on the attendance
        # details obtained above
        attendance_reports = Attendance.objects.filter(attendance_id__in=attendance,
                                                       student_id=stud_obj)
